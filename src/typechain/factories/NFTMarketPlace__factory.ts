...
const _abi = [
  ...
  {
    inputs: [],
    name: "OnlyEthIsAllowed",
    type: "error",
  },
  {
    inputs: [],
    name: "PaymentTokenIsNotApprovedForSale",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "TokenIsNotApprovedForSale",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "UnauthorizedActionByTokenOwner",
    type: "error",
  },
  {
    inputs: [],
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        indexed: false,
        internalType: "enum TokenApprovalStatus",
        name: "status",
        type: "uint8",
      },
    ],
